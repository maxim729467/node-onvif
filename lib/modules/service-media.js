...
OnvifServiceMedia.prototype.getStreamUri = function(params, information, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetStreamUri', soap, information).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
...
OnvifServiceMedia.prototype.getProfiles = function(information, callback) {
	let promise = new Promise((resolve, reject) => {
		...
		let soap = this._createRequestSoap(soap_body);
		mOnvifSoap.requestCommand(this.getRequestParams(), 'GetProfiles', soap, information).then((result) => {
			resolve(result);
		}).catch((error) => {
			reject(error);
		});
